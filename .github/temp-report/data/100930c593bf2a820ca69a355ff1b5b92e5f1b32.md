...
- Name: checkout.spec.ts >> Checkout >> Validações de campos obrigatórios >> deve validar limite mínimo de caracteres para Nome e Sobrenome
- Location: playwright/e2e/checkout.spec.ts:41:5
