...
- Name: checkout.spec.ts >> Checkout >> Validações de campos obrigatórios >> deve exibir erro para e-mail com formato inválido
- Location: playwright/e2e/checkout.spec.ts:69:5
