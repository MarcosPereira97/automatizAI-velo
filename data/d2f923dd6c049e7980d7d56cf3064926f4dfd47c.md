...
- Name: checkout.spec.ts >> Checkout >> Validações de campos obrigatórios >> deve validar obrigatoriedade de todos os campos em branco
- Location: playwright/e2e/checkout.spec.ts:21:5
