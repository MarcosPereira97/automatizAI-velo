...
export function CarStage() {
  ...
  const currentExteriorImage =
    exteriorImages[exteriorColor]?.[wheelType] || glacierBlueAero
  const interiorStyle =
    INTERIOR_COLORS[interiorColor] || INTERIOR_COLORS["carbon-black"]
        ...
        <div className="w-full max-w-4xl animate-scale-in">
          {viewMode === "exterior" ? (
            ...
            >
              <div
                className={cn(
                  "rounded-2xl p-8 aspect-video flex flex-col items-center justify-center",
                  interiorStyle.bg,
                )}
              >
