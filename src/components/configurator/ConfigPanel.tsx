...
const optionalFeatures: {
...
}[] = [
  {
    ...
    description:
      "Sistema avançado de estacionamento totalmente autônomo, capaz de identificar vagas e realizar manobras com precisão e segurança.",
  ...
  },
  {
    ...
    description:
      "Estação de recarga doméstica de alta performance, projetada para oferecer carregamento ultra-rápido, eficiente e seguro.",
...
export function ConfigPanel() {
  ...
  const { configuration, setExteriorColor, setWheelType, toggleOptional } =
    useConfiguratorStore()
