        ...
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-4">
              ...
              <p>
                A Velô está comprometida em proteger sua privacidade. Esta
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  endereço de email, número de telefone, CPF quando você faz uma
                  reserva
                </li>
                <li>
                  <strong>Informações de configuração:</strong> suas
                  preferências de veículo, cores e opcionais selecionados
                </li>
                <li>
                  <strong>Informações de uso:</strong> como você interage com
                  nosso site, páginas visitadas e tempo de permanência
                </li>
                <li>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Enviar informações sobre novos produtos e ofertas (com seu
                  consentimento)
                </li>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                experiência no site. Você pode configurar seu navegador para
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                cumprir os fins para os quais foram coletadas, incluindo
                obrigações legais, contábeis ou de relatório.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                política nesta página com uma nova data de "última atualização".
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                política, entre em contato com nosso Encarregado de Proteção de
                Dados:
              </p>
              <p>
                Email:{" "}
                <a
                  href="mailto:privacidade@velo.com.br"
